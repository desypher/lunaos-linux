    ...
    Rectangle {
        ...
        Column {
            ...
            ScrollView {
                ...
                ListView {
                    model: ListModel {
                        ListElement { name: "File Manager"; category: "System"; icon: "📁" }
                        ListElement { name: "Terminal"; category: "System"; icon: "⌨️" }
                        ListElement { name: "Text Editor"; category: "Accessories"; icon: "📝" }
                        ListElement { name: "Calculator"; category: "Accessories"; icon: "🧮" }
                        ListElement { name: "Settings"; category: "System"; icon: "⚙️" }
                        ListElement { name: "Web Browser"; category: "Internet"; icon: "🌐" }
                        ListElement { name: "Media Player"; category: "Multimedia"; icon: "🎵" }
                        ListElement { name: "Image Viewer"; category: "Graphics"; icon: "🖼️" }
                    }
